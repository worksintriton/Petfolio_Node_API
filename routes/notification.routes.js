...
router.post('/mobile/alert/notification',async function (req, res) {
       var Appointment_details = await AppointmentsModel.findOne({appointment_UID:req.body.appointment_UID}).populate('user_id doctor_id pet_id');
       var appointment_id = Appointment_details.pet_id.pet_name;
       var title  = '';
       var subtitle = '';
       var msg = '';
...
router.post('/mobile/alert/sp_notification',async function (req, res) {
  var Appointment_details = await SP_appointmentsModels.findOne({appointment_UID:req.body.appointment_UID}).populate('user_id sp_id pet_id');
