...
var params1 = {
            ...
            "notify_descri" : "You have a new Appointment with " + petdetailsModels.pet_name + " at " +  req.body.booking_date_time,
            "notify_img" : "",
            "notify_time" : "",
            "date_and_time" : req.body.booking_date_time,
...
request.post(
    ...
    function (error, response, body) {
        ...
        res.json({Status:"Success",Message:"Pet Service Appointment Booked successfully", Data : user ,Code:200}); 
        });
        });
}
catch(e){
