            ...
            res.json({Status:"Success",Message:"Product details list", Data : StateList ,Code:200});
             ...
             for(let a  = 0 ; a < StateList.length ; a ++){
                ...
                if(a == StateList.length - 1){
                   ...
                   res.json({Status:"Success",Message:"Product details list", Data : final_data ,Code:200});
     ...
     if(doctorname.indexOf(keyword) !== -1 == true){
                 if(+StateList[b].cost.toFixed(0) == 0){
                   ...
                   let c = {
                        ...
                        pet_type :  StateList[b].pet_type,
                        pet_breed :  StateList[b].breed_type,
                        pet_age :  StateList[b].age,
