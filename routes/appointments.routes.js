...
router.post('/mobile/create', async function(req, res) {
  try{
    ...
    else
    {
        ...
        var petdetailsModels = await petdetailsModel.findOne({_id:req.body.pet_id});
...
var params = {
            ...
            "notify_descri" : "Your Appointment Has Been Booked successfully For Your Pet " + petdetailsModels.pet_name + " at " + req.body.booking_date_time,
            "notify_img" : "",
            "notify_time" : "",
...
var params1 = {
            ...
            "notify_descri" : "You Have Got a New Appointment with " + petdetailsModels.pet_name  + " at " + req.body.booking_date_time,
            "notify_img" : "",
            "notify_time" : "",
            "date_and_time" : req.body.booking_date_time,
...
var appoint_details = await AppointmentsModel.findOne({_id:req.body._id}).populate('user_id doctor_id pet_id');
var params = {
